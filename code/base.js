...
class controller extends Phaser.Scene {
    ...
    preload() {
        ...
        **/
        ...
        this.load.image('acidflask','assets/items/acidFlask.png');
...
var config = {
    ...
    scene: [controller, titleScreen,tutorial,settingsScreen, difficultyScreen, argoLanding, roadToColchis, marketplace, palace, shrine, shrineForest,
            colchisFields, riverCrossing, gardenEntrance, gardenForest, gardenDungeon, gardenFleece, sidequest1, palaceTreasureRoom ,sidequest2, dragonLevel, interStage1, interStage2, interStage3,medeaCutscene,  
